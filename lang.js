(function () {
  ...
  var zh = {
    ...
    'nav.products':         '产品',
    'nav.mb-options':       '矩阵债券期权',
    'nav.mb-futures':       '矩阵债券期货',
    ...
    /* ── Footer ──────────────────────────────────────────────── */
    'footer.copyright': '版权所有 © 2025 威斯特黄金企业控股有限公司。保留所有权利。',
    ...
    'index.flip1.back-desc':  '利用我们的熊猫债券衍生品对冲货币、利率和信用风险。威斯特黄金企业的定制解决方案助您在动态市场中实现财务稳定。',
    ...
    'index.about.subtitle':    '关于矩阵债券',
    'index.about.title':       '引领熊猫债券衍生品领域',
    'index.about.desc':        '威斯特黄金企业为全球投资者提供熊猫债券及衍生品定制解决方案。凭借风险管理、市场准入和先进交易技术方面的专业知识，我们简化了参与中国动态债券市场的过程。',
    ...
    /* ── About page ──────────────────────────────────────────── */
    'about.page-title': '关于威斯特黄金企业',
    'about.breadcrumb': '关于威斯特黄金企业',
    'about.main-text':
      '<p>&nbsp;</p>' +
      '<p>在威斯特黄金企业，我们处于金融创新的前沿——专注于熊猫债券发行和衍生品。作为全球金融市场的可信伙伴，我们提供量身定制的解决方案，帮助投资者在这个快速扩张的市场中管理风险并优化回报。</p>' +
    ...
    'faqs.q6': '6. 威斯特黄金企业提供哪些熊猫债券衍生品产品？',
    'faqs.a6': '作为熊猫债券衍生品市场的领导者，威斯特黄金企业提供四种衍生品产品：利率互换（IRS）、货币互换、信用违约互换（CDS）以及期货和期权。',
    'faqs.q7': '7. 如何交易威斯特黄金企业提供的衍生品产品？',
    'faqs.a7': '立即联系我们，开立账户。',

    /* ── Futures page ────────────────────────────────────────── */
    'futures.page-title': '矩阵债券期货',
    'futures.breadcrumb': '矩阵债券期货',
    'futures.subtitle':   '威斯特黄金企业',
    'futures.title':      '矩阵债券期货',
    'futures.overview':
      '<h4><strong>概述</strong></h4>' +
      '<p>矩阵债券期货旨在帮助投资者对冲货币和利率波动等风险。这些可交割合约提供灵活且流动性强的机制，以适应多样化的市场策略。</p>',
    'futures.highlights':
    ...
    'futures.cta':
      ...
      '<p>威斯特黄金企业的熊猫债券期货和期权提供参与市场的无缝方式。准备好交易或需要协助？立即联系我们的团队，踏上您的投资之旅。</p>',
